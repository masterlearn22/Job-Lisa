            ...
            <div className="relative z-20 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                  ...
                  <button 
                    onClick={() => handleOpenTracking()}
                    className="w-full sm:w-auto justify-center group bg-white/10 hover:bg-white/20 backdrop-blur-xl active:scale-95 text-white border border-white/20 hover:border-white/40 px-5 sm:px-6 py-3 sm:py-3.5 rounded-xl font-bold text-xs sm:text-sm transition-all duration-300 flex items-center gap-2.5 whitespace-nowrap cursor-pointer shadow-lg shadow-black/20 hover:shadow-white/20 hover:scale-105"
                  >
                    <svg 
                      className="w-4 h-4 text-white/80 group-hover:text-white group-hover:scale-110 transition-all duration-300 drop-shadow-sm" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className="transition-colors duration-300 text-white/90 group-hover:text-white drop-shadow-sm">Lacak Status Lamaran</span>
                  </button>
                </div>
              ...
              <div className="group flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 py-2.5 sm:py-3 px-3.5 sm:px-4 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 hover:border-white/40 transition-all duration-300 text-xs shadow-lg shadow-black/20 hover:shadow-white/10">
                <div className="flex items-center gap-2 overflow-hidden w-full sm:w-auto">
                  <span className="relative flex h-2 w-2 shrink-0">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-500 opacity-75 group-hover:bg-red-400 transition-colors duration-300"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500 group-hover:bg-red-400 transition-colors duration-300"></span>
                  </span>
                  <span className="font-semibold text-white/70 group-hover:text-white transition-colors duration-300 shrink-0 text-[11px] sm:text-xs drop-shadow-sm">
                    Showcase:
                  </span>
                  <span className="text-white/90 font-bold truncate transition-all duration-300 hover:text-white cursor-pointer text-[11px] sm:text-xs drop-shadow-sm">
                    {HERO_SLIDES[heroSlide]?.title}
                  </span>
                  <span className="text-white/50 hidden md:inline">&mdash;</span>
                  <span className="text-white/70 hidden md:inline truncate group-hover:text-white transition-colors duration-300 drop-shadow-sm">
                ...
                <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-2 shrink-0">
                  ...
                  <span className="text-[10px] font-bold text-white/70 font-mono tracking-widest pl-2 border-l border-white/20 drop-shadow-sm">
      ...
      <section id="tahapan" className="py-16 sm:py-24 bg-gradient-to-b from-slate-50 via-white to-slate-50 border-y border-slate-200/80 w-full max-w-full overflow-hidden relative">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="hidden lg:block">
            ...
            <div className="hidden lg:grid grid-cols-6 gap-3.5 xl:gap-4 relative">
              {RECRUITMENT_STAGES.map((st, idx) => (
                <div 
                  key={idx}
                  className="relative h-56 group cursor-pointer [perspective:1000px]"
                >
                  <div className="w-full h-full relative transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    ...
                    <div className="absolute inset-0 [backface-visibility:hidden] bg-white rounded-2xl border border-slate-200/90 shadow-xs p-4 flex flex-col justify-between overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center justify-between gap-2 mb-3">
                          <div className="w-9 h-9 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-700 flex items-center justify-center shrink-0">
                            {getStageIcon(st.iconType)}
                          </div>
                          <span className="font-mono text-[9px] font-black text-slate-400 bg-slate-100 border border-slate-200/60 px-2 py-0.5 rounded-md">
                            {st.stage}
                          </span>
                        </div>
                    ...
                    {/* --- Sisi Belakang (Back) --- */}
                    <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] bg-slate-900 rounded-2xl border border-red-500/50 shadow-xl p-4 flex flex-col justify-center items-center text-center overflow-hidden">
          ...
          <div className="lg:hidden flex overflow-x-auto gap-4 pb-8 px-1 mt-6 snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {RECRUITMENT_STAGES.map((st, idx) => (
              <label key={idx} className="relative shrink-0 w-[65vw] sm:w-[45vw] h-52 snap-center cursor-pointer [perspective:1000px] group block">
                ...
                <div className="w-full h-full relative transition-transform duration-700 [transform-style:preserve-3d] peer-checked:[transform:rotateY(180deg)]">
                  ...
                  {/* --- Sisi Depan (Front) --- */}
                  <div className="absolute inset-0 [backface-visibility:hidden] bg-white rounded-2xl border border-slate-200/90 shadow-sm p-4 flex flex-col justify-between overflow-hidden">
                    <span className="absolute -bottom-3 -right-1 font-mono font-black text-6xl text-slate-100 select-none pointer-events-none">
                      {st.no}
                    </span>
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-700 flex items-center justify-center shrink-0 shadow-xs">
                          {getStageIcon(st.iconType)}
                        </div>
                        <span className="font-mono text-[9px] font-black text-slate-500 bg-slate-100 border border-slate-200/60 px-2 py-0.5 rounded-md">
                          {st.stage}
                        </span>
                      </div>
                    ...
                    <div className="relative z-10 mt-1 pt-2 border-t border-slate-100 flex items-center justify-between text-[9px] text-slate-400">
                      <span className="font-medium text-slate-500 truncate">{st.format}</span>

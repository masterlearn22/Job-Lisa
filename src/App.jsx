            ...
            <div className="relative z-20 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                  ...
                  >
                    <span className="transition-colors duration-300 text-red-600 group-hover:text-red-500 drop-shadow-sm font-black">Lihat Lowongan Kerja ({jobs.length} Posisi)</span>
                    <svg 
                      className="w-4 h-4 shrink-0 text-red-600 group-hover:text-red-500 transition-all duration-300 group-hover:translate-x-1.5 drop-shadow-sm" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
                  ...
                  >
                    <svg 
                      className="w-4 h-4 text-red-500 group-hover:text-red-400 group-hover:scale-110 transition-all duration-300 drop-shadow-sm" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className="transition-colors duration-300 text-red-500 group-hover:text-red-400 drop-shadow-sm font-black">Lacak Status Lamaran</span>
                  </button>
                </div>
            ...
            <div className="relative z-20 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-8">
              <div className="group flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 py-2.5 sm:py-3 px-3.5 sm:px-4 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 hover:border-white/40 transition-all duration-300 text-xs shadow-lg shadow-black/20 hover:shadow-white/10">
                <div className="flex items-center gap-2 overflow-hidden w-full sm:w-auto">
                  ...
                  <span className="font-bold text-red-500 group-hover:text-red-400 transition-colors duration-300 shrink-0 text-[11px] sm:text-xs drop-shadow-sm">
                    Showcase:
                  </span>
                  <span className="text-red-600 font-black truncate transition-all duration-300 hover:text-red-500 cursor-pointer text-[11px] sm:text-xs drop-shadow-sm">
                    {HERO_SLIDES[heroSlide]?.title}
                  </span>
                  <span className="text-red-400/50 hidden md:inline">&mdash;</span>
                  <span className="text-red-500/80 font-medium hidden md:inline truncate group-hover:text-red-400 transition-colors duration-300 drop-shadow-sm">
                    ...
                    {HERO_SLIDES.map((slide, idx) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 cursor-pointer ${
                          idx === heroSlide 
                            ? 'w-7 sm:w-8 bg-red-600 shadow-[0_0_8px_rgba(220,38,38,0.8)]' 
                            : 'w-2 bg-red-500/40 hover:bg-red-500/80 hover:scale-125 hover:w-4'
                        }`}
                        title={slide.title}
                      />
                    ))}
                  </div>
                  <span className="text-[10px] font-black text-red-500 font-mono tracking-widest pl-2 border-l border-white/30 drop-shadow-sm">
